...
public class OrderService {
    ...
    private final WebClient customerClient = WebClient.builder()
        ...
        return customerClient.get()
                ...
                .exchangeToMono(response -> {
                    if (response.statusCode().is2xxSuccessful()) {
                        ...
                        return Mono.error(new IllegalArgumentException("El cliente con ID " + customerId + " no existe."));
                    } else {
                        return Mono.error(new IllegalStateException("Error inesperado al validar cliente: " + response.statusCode()));
                    }
                });
    }
